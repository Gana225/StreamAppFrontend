...
export default function Trending() {
  ...
  if (loading) return <div className="text-center text-zinc-400 mt-20">Loading Trending Matrix...</div>;

  return (
    <div className="p-4 w-full">
      <h2 className="text-xl font-bold text-zinc-100 mb-6">Trending Content</h2>
          ...
          >
            ...
            <div className="flex gap-3 px-1">
              ...
              <div className="flex flex-col flex-1 min-w-0">
                ...
                <p className="text-[11px] text-zinc-500">{video.views_count} views</p>
              </div>
            </div>
          </article>
        ))}
